 ...
 * @author Adriano Silva
 */
public class cad_logradouro extends javax.swing.JFrame {
     ...
     */
    public cad_logradouro() {
        initComponents();
        con_logradouro = new conexao();
        con_logradouro.conecta();
        con_logradouro.executeSQL("select * from logradouro order by "+ordenacao);
       
        
        try
        {
          while (con_logradouro.resultset.next())
          jcb_pesquisa.addItem(con_logradouro.resultset.getString("nome"));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/cadastro_endereco.jpg"))); // NOI18N

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("Código.:");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("Endere.:");
 ...
 try
    ...
    private void botão_gravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botão_gravarActionPerformed
        ...
        try
        {
            ...
            String sqlinsert ="insert into logradouro (nome) values ('"+
                         tf_nome.getText()+"')";
           ...
           con_logradouro.resultset.first(); //posiciona no primeiro registro
        ...
        try
    {
   	...
   	con_logradouro.executeSQL(sql); 
        con_logradouro.resultset.first();
        String nome = "Deletar o Endereço : "+con_logradouro.resultset.getString("nome")+" ?";
    ...
    private void botao_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_alterarActionPerformed
        try
    {
        String sql ="UPDATE logradouro SET nome ='"+tf_nome.getText()+"' where codigo = "+tf_codigo.getText();
       ...
       con_logradouro.executeSQL("select * from logradouro order by "+ordenacao);
       atualiza_combo_box_cidade();
       con_logradouro.resultset.next(); //posiciona no primeiro registro
       mostrar_dados(); //irá chamar a função em que irá mstrar os dados no form
     }
     catch (SQLException erro)
     {
        ...
        try
         {
                ...
                {
                        if (con_logradouro.resultset.getString("nome").equals(jcb_pesquisa.getSelectedItem()))
                        {
                            igual = "s"; //indica que achou a cidade
                        }
                        else
                            con_logradouro.resultset.next(); //enquanto não achar vai para o proximo                   
                    }
                   // nas linhas abaxo, mostra_conteudo_tabela();
                  tf_codigo.setText(con_logradouro.resultset.getString("codigo"));//Essas duas linhas são necesárias                   
                   mostrar_dados();
               }
    ...
    private void tf_pesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_pesquisaActionPerformed
        try
        {
               ...
               // nas linhas abaxo, mostra_conteudo_tabela();
               tf_codigo.setText(con_logradouro.resultset.getString("codigo"));//Essas duas linhas é necesária                   
               mostrar_dados();                              
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        con_logradouro.executeSQL("select * from logradouro where nome like '"+tf_pesquisa.getText()+"%' order by "+ordenacao);          
          preencher_jtable();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cad_logradouro().setVisible(true);
            }
        });
    }
    ...
    public void mostrar_dados()
    {
         try
        {
           ...
           //cb_cidade.setSelectedItem(con_logradouro.resultset.getString("uf"));
        }
        catch(SQLException erro)
        {
            if (navega == 1)
